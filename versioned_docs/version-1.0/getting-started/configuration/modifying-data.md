...
This is the structure of `db/data.json` file.

:::caution
Modifying the structure of `db/data.json` file will cause the app to crash.
:::
...
You can modify your personal info by editing object value on `db/data.json` file.

```json
{
  "hero": {
    "fullName": "Deri Kurniawan", // change this to your full name
    "jobTitle": "Full Stack Developer", // change this to your job title
    "image": "https://res.cloudinary.com/deri-kurniawan/image/upload/v1663610416/Deri%20Kurniawan%20Portfolio%20Web%20App/Hero_o6ubic.png" // change this to your image url
  }
  // ...other objects
}
```
...
```json title="db/data.json"
{
  "hero": {
    "fullName": "Deri Kurniawan",
    "jobTitle": "Full Stack Developer",
    "image": "https://res.cloudinary.com/deri-kurniawan/image/upload/v1663610416/Deri%20Kurniawan%20Portfolio%20Web%20App/Hero_o6ubic.png"
  },
  "navLinks": [
    {
      "id": "home",
  ...
  "projects": [
    {
      ...
      "image": "https://res.cloudinary.com/deri-kurniawan/image/upload/v1663606820/Deri%20Kurniawan%20Portfolio%20Web%20App/projects/Project-1_iynwb0.png",
      "description": "Windows 11 OS clone as website using React JS + Tailwindcss. Checkout this live site on <a class=\"text-secondary\" href=\"https://deri-kurniawan.vercel.app/\" target=\"_blank\">Vercel</a>"
    },
    {
  ...
  "educations": [
    {
      ...
      "description": "- <a class=\"hover:text-secondary\" href=\"https://www.google.com/search?q=pramuka\" target=\"_blank\">Praja Muda Karana (Scouting)</a>",
      "timeRange": "2007 - 2013",
    ...
    },
    {
      ...
      "description": "- <a class=\"hover:text-secondary\" href=\"https://www.google.com/search?q=palang+merah+remaja\" target=\"_blank\">Palang Merah Remaja (Medical Extracurricular)</a>",
      "timeRange": "2013 - 2016",
    ...
    },
    {
      ...
      "description": "- <a class=\"hover:text-secondary\" href=\"https://www.google.com/search?q=palang+merah+remaja\" target=\"_blank\">Organisasi Siswa - IT Division (Student Organization)</a><br/>- Delta Music (Music Extracurricular)<br/>- IT Club (Tech Extracurricular)",
      "timeRange": "2016 - 2019",
    ...
    },
    {
      ...
      "description": "- <a class=\"hover:text-secondary\" href=\"http://drive.google.com/uc?export=view&id=1q0ERTFZFvh0cVuczbXmRhNrrBHMNVt7v\" target=\"_blank\">Studi Independen Kampus Merdeka Batch 1 (23 Aug 2021-19 Jan 2022)</a>",
      "timeRange": "2019 - Now",
  ...
  "feedbacks": [
    {
      ...
      "review": "Deri Kurniawan is a very competent person in the field of multiplatform applications."
    },
    {
      "name": "Vanessa Angela",
      "position": "UI/UX Designer",
      "avatar": "https://picsum.photos//id/64/200",
      "review": "Deri Kurniawan is a very professional person and has helped me complete a project owned by the company."
    },
    {
      "name": "Kenn Gallanger",
      "position": "CEO & Founder",
      "avatar": "https://picsum.photos/id/177/200",
      "review": "There can be no doubt about this Deri's ability. I am very happy to be able to use his services."
    }
  ],
  "footer": [
    {
